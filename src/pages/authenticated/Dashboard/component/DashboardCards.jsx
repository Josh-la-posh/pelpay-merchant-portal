...
function DashboardCards({ lumpsum }) {
  ...
  return (
    <div className="grid grid-cols-3 md:grid-cols-1 gap-4 lg:gap-0 mb-8 md:mb-0">
      <Card title="Total Revenue" value={`₦${totalRevenue}`} color="bg-[#EEE8FA]" icon={<CircleDollarSign size='15px' className='text-[#7447C6]' />} />
      <Card title="Total Transactions" value={totalCounts} color="bg-[#FFF8E1]" color2= "bg-[#0000FF]" icon={<ShoppingCart size='15px' className='text-[#FFC107]' />} />
